...
class Producto(models.Model):
    ...
    cantidad = models.DecimalField(
        ...
        help_text='Cantidad disponible en inventario (puede ser fraccionada)'
    )
    ...
    es_por_peso = models.BooleanField(
        default=False,
        help_text='Si está marcado, el stock se maneja en gramos y el precio es por Kg. (Ej: 1000 unidades = 1 Kg)'
    )
...
class MovimientoInventario(models.Model):
    ...
    cantidad_anterior = models.DecimalField(max_digits=12, decimal_places=3)
    cantidad_nueva = models.DecimalField(max_digits=12, decimal_places=3)
